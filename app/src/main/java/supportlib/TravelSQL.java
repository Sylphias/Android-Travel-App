...
public class TravelSQL extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        cv.put("privatetime","14,0,81,88,39,264,23,142,38,221");
        ...
        cv.put("privatetime","69,81,0,12,47,270,63,65,51,282");
        ...
        cv.put("privatetime","76,88,12,0,55,285,75,83,63,294");
        ...
        cv.put("privatetime","28,39,47,55,0,264,17,107,5,234");
        ...
        cv.put("privatetime","269,264,270,285,264,0,280,121,281,247");
        ...
        cv.put("privatetime","20,23,63,75,17,280,0,122,17,227");
        ...
        cv.put("privatetime","129,142,65,83,107,262,121,0,141,320");
        ...
        cv.put("privatetime","232,220,281,293,234,249,225,324,230,0");
